		...
		public:
			...
			bool evaluateExt(VContainer* v) {
				...
				case Base::Decl::INT:
				{
					switch (rootRight) {
					case Base::Decl::INT:
						return oper->equate<int, int>(v->cast<int>(), std::any_cast<int>(right->calc()));
					case Base::Decl::FLOAT:
						return oper->equate<int, float>(v->cast<int>(), std::any_cast<float>(right->calc()));
					case Base::Decl::STRING:
						break;
				...
				case Base::Decl::FLOAT:
				{
					switch (rootRight) {
					case Base::Decl::INT:
						return oper->equate<float, int>(v->cast<float>(), std::any_cast<int>(right->calc()));
					case Base::Decl::FLOAT:
						return oper->equate<float, float>(v->cast<float>(), std::any_cast<float>(right->calc()));
					case Base::Decl::STRING:
						break;
						//return oper->equate<int, String>(l, s);
					}
				...
				case Base::Decl::STRING:
				{
					...
					case Base::Decl::FLOAT:
						break;
					case Base::Decl::STRING:
						return oper->equateSimple<String, String>(v->cast<String>(), std::any_cast<String>(right->calc()));
					}
